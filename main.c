...
void agendar_compromisso(int compromissos[], int ano, int dias_no_mes[])
{
  ...
  // Verificar se já existem compromissos marcados para este dia
  ...
  // Atualizar o array de compromissos para a duração especificada
  for (int i = 0; i < duracao; i++)
  {
    ...
    compromissos[indice + i] += 1; // Incrementar contagem de compromissos para cada dia do tratamento
  }
